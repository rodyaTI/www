<?php
$this->pageTitle=Yii::app()->name . ' - ' . tt('Manage settings');
...
$this->adminTitle = tt('Manage settings');
...
<script type="text/javascript">
    function updateConfig(href){
        $('#myModal').modal('show');
        $('#form_param').html('<img src="<?php echo Yii::app()->request->baseUrl."/images/pages/indicator.gif"; ?>" alt="<?php echo tc('Loading content...'); ?>" style="position:absolute;margin: 10px;">');
