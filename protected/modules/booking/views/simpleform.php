...
<div class="form min-fancy-width">
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="row">
			...
			<?php echo $form->dropDownList($model,'type', $type, array('class' => 'width200', 'id'=>'ap_type_form', 'onChange' => 'apTypeChange(this)')); ?>
...
<?php
	...
	Yii::app()->clientScript->registerScript('show-rent-form', '
	    if (document.getElementById("ap_type_form")) {
            var apTypeValue = document.getElementById("ap_type_form").value;
